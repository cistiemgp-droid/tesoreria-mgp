...
async function guardarMovimiento(evento) {
    ...
    try {
        ...
        try {
            // IMPORTANTE: esta llamada se ejecuta UNA sola vez.
            // Si el transporte falla después de que Apps Script escribió
            // el registro, NO se vuelve a enviar automáticamente.
            ...
            // Puede haber ocurrido un guardado correcto aunque la respuesta
            // JSONP no haya llegado al navegador.
            btnGuardar.textContent = 'Verificando...';

            const verificacion =
                await verificarMovimientoRegistrado(datos);
